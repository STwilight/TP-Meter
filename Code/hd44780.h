...
// ENTRY MODE MACROS
//-------------------------------
#define ENTRY_MODE_DEC_NO_SHIFT	      0x04 // справа на лево, без сдвига видимой части DDRAM памяти
#define ENTRY_MODE_DEC_WITH_SHIFT     0x05 // справа на лево, со сдвигом видимой части DDRAM памяти
#define ENTRY_MODE_INC_NO_SHIFT	      0x06 // слева на право, без сдвига видимой части DDRAM памяти
#define ENTRY_MODE_INC_WITH_SHIFT     0x07 // слева на право, со сдвигом видимой части DDRAM памяти
